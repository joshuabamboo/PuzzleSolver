...
# count occurances
characters.each {|character| character_count[character] = elements.count(character)}

# sort values in descending order
sorted_values = character_count.values.sort {|a,b| b<=>a}

# remove all values after and including _ 
underscore_value = character_count['_']
important_values = sorted_values.delete_if {|value| value <= underscore_value}

# collect the message
mystery_message = important_values.collect {|value| character_count.key(value)} 
